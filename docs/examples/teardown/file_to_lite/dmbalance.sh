...
time python cli.py -nopp 5 -dcf config/db_config.DEV.json -pcf config/proc/teardown/file_to_lite/dmbalance.json --proc_params \
in/tear.file_to_lite.py ./dump/tear/file_to_lite/ ./dump/lite/  email-y show-y
