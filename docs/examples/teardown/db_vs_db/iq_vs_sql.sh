...
time python cli.py -nopp 3 -dcf config/db_config.DEV.json -pcf config/proc/teardown/db_vs_db/iq_vs_sql.json --proc_params \
...
time python cli.py -nopp 5 -dcf config/db_config.DEV.json -pcf config/proc/teardown/db_vs_db/iq_vs_sql.json --proc_params \
