...
time python cli.py -nopp 2 -dcf config/db_config.DEV.json -pcf config/proc/query_dump/iq_query_file/q_dump.json --proc_params   \
in/sync.iq_sql.sql './dump/10' -ld 10
