"""
 time python cli.py -nopp 4 --dump  -dcf config/db_config.json -pcf config/proc/snow_url_snow/DY_FinancingPosition.json \
 --proc_params  Repo '2019-05-01 00:00:00' "$(date +"%Y-%m-%d %H:%M:%S")" $GA_TOCKEN
#
# pa[0] = ReferenceType
# pa[1] = AccountingDate
# pa[2] = AsOfDateTime
